...
- [第4章 实验设计与结果分析（初稿）](thesis_experiment_chapter/EXPERIMENT_CHAPTER_DRAFT.md)：统一汇总核心复现、消融、部署、推理扩展、负结果和后续优先级。
...
- [P5-lite 仅增强最终P4（50轮筛选结果）](p5lite_p4only/SCREEN_REPORT.md)
- [尺度梯度冲突诊断（结果）](scale_gradient_conflict/README.md)
